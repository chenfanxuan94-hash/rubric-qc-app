...
import {
  ...
  WRITING_PRINCIPLES, GOLDEN_PATTERNS,
...

{
  ...
  "major_risks": [
    { "code": "M#", "title": "...", "what": "what you saw in the text", "why": "why it risks a Major / 0%", "evidence": "short quote from the text or '—'", "confirm": "the exact thing the tasker must verify against the cameras" }
  ],
  "minor_flags": [
    { "code": "m#", "title": "...", "detail": "...", "evidence": "short quote or '—'", "fix": "how to fix it" }
  ],
