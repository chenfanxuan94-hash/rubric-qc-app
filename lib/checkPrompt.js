...
`;
    ...
    const framesNote = payload.frameCount ? `FOOTAGE FRAMES PROVIDED: ${payload.frameCount} screen-captured frame(s) from the task's camera footage are attached BEFORE this text.
