...
${frameList}
Frames with t= values are chronological samples (~1 second apart) across the clip — use them for temporal questions (cut-ins, light state changes, whether a school bus is active).
