...
- GRAMMAR: typos, run-ons, and CLOSING leftover scaffolding ("This covers all the required parts", "Drafting the final output"). Do NOT flag the standard trace opener "The user wants me to act as a VLM..." or numbered stage headers — they are expected. Every grammar finding must include the concrete correction (quote original → replacement).
