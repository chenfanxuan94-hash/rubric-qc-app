...
- ALWAYS fill "note" with a SHORT, EXPLICIT description of WHERE/WHAT the change is, so the user doesn't have to hunt for it. Examples: "extra space between 'vehicles' and 'partially'", "doubled word 'the the'", "missing comma after 'stalled'", "'i' should be capital 'I'". Keep it under 10 words.
